...
# meta developer: @codermasochist,@Yaukais
...
class AsEditsMod(loader.Module):
    """Модуль кидает ахуенные эдиты. by @codermasochist,@Yaukais"""
    ...
    async def asedit(self, message: Message):
        ...
        try:
            videos = [
                ...
                ) if msg.video  # Проверка на наличие видео
            ]
            ...
            await utils.answer(message, str(e) or self.strings["no_videos_found"])
