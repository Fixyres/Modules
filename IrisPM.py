...
class IrisMods(loader.Module):
    ...
    async def хелп(self, message):
        ...
        async with message.client.conversation(chat) as conv:
            ...
            response1 = await conv.wait_event(events.NewMessage(incoming=True, from_users=5720028884))
            await message.edit(response1.text)
            response2 = await conv.wait_event(events.NewMessage(incoming=True, from_users=5720028884))
            await message.edit(response2.text)
